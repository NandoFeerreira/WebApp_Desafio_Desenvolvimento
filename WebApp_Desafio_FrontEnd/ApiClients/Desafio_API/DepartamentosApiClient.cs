...
namespace WebApp_Desafio_FrontEnd.ApiClients.Desafio_API
{
    public class DepartamentosApiClient : BaseClient
    {
        ...
        public DepartamentoViewModel DepartamentoObterPorId(int idDepartamento)
        {
            ...
            var response = base.Get($"{desafioApiUrl}{departamentosListUrl.Replace("Listar", "Obter")}", querys, headers);
        ...
        public bool DepartamentoExcluir(int idDepartamento)
        {
            ...
            var response = base.Delete($"{desafioApiUrl}{departamentosListUrl.Replace("Listar", "Excluir")}", querys, headers);
